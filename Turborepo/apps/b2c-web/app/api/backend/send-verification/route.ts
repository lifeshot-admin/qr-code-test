                ...
                value: `
                  <div style="font-family: 'Apple SD Gothic Neo', sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 20px;">
                    <div style="text-align: center; margin-bottom: 32px;">
                      <h1 style="color: var(--cheiz-primary); font-size: 24px; margin: 0;">CHEIZ</h1>
                    ...
                    <div style="background: #F8F9FA; border-radius: 16px; padding: 32px; text-align: center;">
                      ...
                      <div style="background: var(--cheiz-primary); color: white; font-size: 32px; font-weight: bold; letter-spacing: 8px; padding: 16px 24px; border-radius: 12px; display: inline-block;">
                        ${code}
                      </div>
