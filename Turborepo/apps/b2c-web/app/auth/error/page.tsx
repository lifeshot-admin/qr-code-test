    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6">
      ...
      >
        ...
        >
          <Link
            href="/cheiz"
            className="block w-full bg-cheiz-primary text-white font-bold py-4 px-8 rounded-xl hover:bg-opacity-90 transition-all shadow-sm"
          >
            홈으로 돌아가기
          </Link>
          <Link
            href="/auth/signin"
            className="block w-full bg-white text-cheiz-primary border-2 border-cheiz-primary font-bold py-4 px-8 rounded-xl hover:bg-cheiz-primary hover:text-white transition-all"
          >
            다시 로그인하기
          </Link>
        </motion.div>
