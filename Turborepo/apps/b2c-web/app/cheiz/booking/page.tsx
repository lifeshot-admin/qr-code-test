        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-100 rounded-xl focus:outline-none focus:border-cheiz-primary"
            />
          </div>
          ...
          <button
            ...
            className="w-full bg-cheiz-primary text-white font-bold py-4 rounded-xl hover:bg-opacity-90 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
