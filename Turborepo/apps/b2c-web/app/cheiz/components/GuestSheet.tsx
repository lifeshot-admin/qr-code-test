          ...
          >
            ...
            <div className="px-6 pt-3 pb-2 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Camera className="w-5 h-5 text-cheiz-primary" />
                  ...
                  <button
                    ...
                    className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all ${
                      adults <= 0
                        ...
                        : "border-gray-300 text-gray-600 hover:border-cheiz-primary hover:text-cheiz-primary active:scale-90"
                    }`}
                  >
                  ...
                  return (
                    <motion.button
                      ...
                      className={`relative flex flex-col items-center gap-2 py-4 rounded-2xl border-2 transition-all duration-200 ${
                        isActive
                          ? "border-cheiz-primary bg-gradient-to-b from-cheiz-surface to-white shadow-md shadow-cheiz-primary/10"
                    ...
                    >
                      {isActive && (
                        <motion.div
                          ...
                          className="absolute inset-0 rounded-2xl bg-cheiz-primary/5"
                      ...
                      <span
                        className={`text-[11px] font-bold relative z-10 leading-tight text-center ${
                          isActive ? "text-cheiz-primary" : "text-gray-500"
                        }`}
                      >
                        {opt.label}
                      </span>
              ...
              <motion.button
                ...
                className={`w-full py-4 rounded-2xl font-bold text-base transition-all flex items-center justify-center gap-2 ${
                  !canConfirm
                    ...
                    : confirming
                    ? "bg-cheiz-dark text-white/80 shadow-lg shadow-cheiz-primary/25"
