    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-xl h-16 w-16 border-t-4 border-cheiz-primary border-solid mx-auto mb-4"></div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <motion.section
        ...
        className="bg-cheiz-primary text-white py-8 px-6 sticky top-0 z-10 shadow-sm"
      >
        <div className="max-w-md mx-auto flex justify-between items-center">
          ...
          <button
            ...
            className="bg-white text-cheiz-primary font-bold py-3 px-8 rounded-xl hover:bg-opacity-90 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
          >
            선택 완료
          </button>
        </div>
                ...
                return (
                  <motion.div
                    ...
                    className={`relative rounded-2xl overflow-hidden cursor-pointer shadow-sm transition-all transform hover:scale-105 ${
                      isSelected ? "ring-4 ring-cheiz-primary" : ""
                    }`}
                  >
                    {/* Image */}
                    <div className="aspect-[3/4] bg-gray-200 relative">
                      ...
                      {isSelected && (
                        <motion.div
                          initial={{ scale: 0 }}
                          animate={{ scale: 1 }}
                          className="absolute top-4 right-4 bg-cheiz-primary text-white rounded-xl w-10 h-10 flex items-center justify-center shadow-sm"
                        >
                          <svg
                            className="w-6 h-6"
                            fill="none"
