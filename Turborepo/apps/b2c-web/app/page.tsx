    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
      ...
      >
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <div className="w-20 h-20 bg-cheiz-primary rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
            <Camera className="w-10 h-10 text-white" />
          </div>
          <h1 className="text-4xl font-bold text-[#1A1A1A]">
            <span className="text-cheiz-primary">Cheiz</span>
          </h1>
        ...
        >
          <Link
            href="/cheiz"
            className="flex items-center justify-center gap-2 w-full h-14 bg-cheiz-primary hover:bg-cheiz-primary/90 text-white font-semibold rounded-xl transition-all shadow-lg"
          >
            Cheiz 메인 서비스 시작하기
