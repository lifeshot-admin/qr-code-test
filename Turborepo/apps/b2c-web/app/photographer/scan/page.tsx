  ...
  return (
    <div className="h-screen flex items-center justify-center bg-black">
      <div className="text-center">
        <div className="w-12 h-12 border-4 border-cheiz-primary border-t-transparent rounded-full animate-spin mx-auto mb-4" />
...
export default function ScanPage() {
  return (
    <Suspense
      fallback={
        <div className="h-screen flex items-center justify-center bg-black">
          <div className="w-12 h-12 border-4 border-cheiz-primary border-t-transparent rounded-full animate-spin" />
        </div>
      }
    >
      <ScanRedirect />
