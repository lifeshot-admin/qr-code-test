      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <div className="w-10 h-10 rounded-xl bg-cheiz-surface flex items-center justify-center">
                  <Download className="w-5 h-5 text-cheiz-primary" />
                </div>
                <div>
            ...
            <div className="flex gap-3">
              ...
              <button onClick={downloadAll}
                className="flex-1 py-3 rounded-xl bg-cheiz-primary text-white text-sm font-bold active:scale-[0.97] transition-all shadow-lg shadow-cheiz-primary/20 flex items-center justify-center gap-1.5">
        ...
        {phase === "downloading" && (
          <div className="p-6">
            <div className="text-center mb-5">
              <Loader2 className="w-10 h-10 text-cheiz-primary animate-spin mx-auto mb-3" />
            ...
            <div className="w-full bg-gray-100 rounded-full h-3 overflow-hidden mb-3">
              <div
                className="h-full bg-gradient-to-r from-cheiz-primary to-cheiz-primary rounded-full transition-all duration-300"
        ...
        {phase === "done" && (
          <div className="p-6 text-center">
            ...
            <button onClick={onClose}
              className="w-full py-3 rounded-xl bg-cheiz-primary text-white text-sm font-bold active:scale-[0.97] transition-all">
              확인
            </button>
          </div>
        )}
