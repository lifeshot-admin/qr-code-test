...
function EmptyState() {
  return (
    <div className="bg-gray-50 rounded-2xl p-8 text-center">
      <div className="w-14 h-14 mx-auto mb-3 rounded-2xl bg-cheiz-primary/10 flex items-center justify-center">
        <Calendar className="w-7 h-7 text-cheiz-primary/40" />
      </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content — 제목 + 장소 + 가격만 */}
        <div className="p-3">
          <h3 className="font-bold text-[#1A1A1A] text-sm leading-snug mb-1.5 line-clamp-2 group-hover:text-cheiz-primary transition-colors">
            {tour.name}
          </h3>
    ...
    <section>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-bold text-[#1A1A1A] flex items-center gap-2">
          <div className="w-1 h-5 bg-cheiz-primary rounded-full" />
          추천 투어
        </h2>
