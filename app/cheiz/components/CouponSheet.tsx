              ...
              {!result ? (
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-[72px] pr-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:border-[#0055FF] text-[#1A1A1A] transition-colors"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 h-14 text-lg tracking-widest text-center border border-gray-200 rounded-xl focus:outline-none focus:border-[#0055FF] text-[#1A1A1A] transition-colors placeholder:text-gray-400"
                      />
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full h-14 bg-[#0055FF] hover:bg-[#0055FF]/90 text-white font-semibold rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                  >
                    {searching ? "조회 중..." : "확인하기"}
                  </button>
                </div>
                ...
                >
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      onClick={handleCopy}
                      className="flex-1 h-12 bg-[#0055FF] hover:bg-[#0055FF]/90 text-white font-semibold rounded-xl transition-all"
                    >
