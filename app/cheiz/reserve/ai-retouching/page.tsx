    ...
    <div className="min-h-screen bg-[#FFF9F5] pb-44">
      ...
      <div className="max-w-md mx-auto px-5 py-2">
        ...
        >
          ...
          <div className="flex justify-between px-4 py-3 bg-white/90 backdrop-blur-sm">
            ...
            <span className="text-xs font-medium text-[#0055FF] flex items-center gap-1">
      ...
      <div className="max-w-md mx-auto px-5 py-2">
        <motion.div
          ...
          className="bg-gradient-to-r from-[#0055FF]/5 to-purple-50 rounded-2xl p-5 border border-[#0055FF]/10"
        >
        ...
        <div className="max-w-md mx-auto px-5 py-4 space-y-3">
          <motion.button
            ...
            className={`w-full py-4 rounded-2xl font-bold text-base flex items-center justify-center gap-2 transition-all ${
              selected === true
                ? "bg-[#0055FF] text-white shadow-lg shadow-blue-500/25 ring-2 ring-[#0055FF]/50"
